...
**Figure 2: Sweet-rate and rich-rate by ranking tier.**
...
**Figure 3: Keyword frequency in review text (by ranking tier)**
...
**Figure 4: Flavor profiles of the Top 10 brands.**
...
**Figure 5: Comparison of taste distributions.**
...
**Figure 6: Time series of taste tendencies (structured data, all brands)**
...
**Figure 7: Time series of keyword frequencies (text analysis, all brands)**
...
**Figure 8: Google Trends for sake-related search terms in Japan (2004–2025)**
...
**Appendix Figure 1: Rating score vs. review count (Top 10 labeled)**
...
**Appendix Figure 2: Average rating by specific-name classification**
...
**Appendix Figure 3: Sakenowa — flavor tag frequency by ranking tier (left) and 6-axis flavor chart averages (right)**
