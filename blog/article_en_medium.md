...
![Frequency of taste-related words in Japanese publications (1880–2000). Source: NDL Ngram Viewer.](medium/fig1_ndl.png)
...
![Sweet vs Dry rate by ranking tier](medium/fig2_sweet_dry.png)
...
![Keyword frequency in review text by ranking tier](medium/fig3_text_keywords.png)
...
![Top 9 sake flavor profiles](medium/fig4_radar.png)
...
![Taste distribution comparison by ranking tier](medium/fig5_heatmap.png)
...
![Time series of taste tendencies](medium/fig6_trend_structured.png)
...
![Keyword frequency trends over time](medium/fig7_trend_text.png)
...
![Google Trends for sake-related search terms](medium/fig8_google_trends.png)
...
![Rating score vs review count](medium/appfig1_rating_reviews.png)
...
![Average rating by classification](medium/appfig2_specname.png)
...
![Sakenowa flavor chart by ranking tier](medium/appfig3_sakenowa.png)
